...
@Component({
  selector: 'app-topic-pane-chart-series',
  templateUrl: './topic-pane-chart-series.component.html',
  styleUrls: ['./topic-pane-chart-series.component.css']
})
export class TopicPaneChartSeriesComponent implements OnInit, OnDestroy {
  id: any;
  chartForm: FormGroup;
