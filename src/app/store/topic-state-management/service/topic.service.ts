...
export class TopicService {
  ...
  loadDataFieldByPaneId(paneId: number, force ?: boolean) {
    return this.store.dispatch(new LoadDataFiledByPaneId(paneId,force))
  }
  ...
  savePaneReportParameter(paneId : number, paneReportId : number, body : any){
    return this.store.dispatch(new SaveNewPaneReportParameterAction(paneId,paneReportId,body));
  }

  deletePaneReportParameter(paneId : number, paneReportId : number, paneReportParameterId : number){
    return this.store.dispatch(new DeletePaneReportParameterAction(paneId,paneReportId,paneReportParameterId));
  }
