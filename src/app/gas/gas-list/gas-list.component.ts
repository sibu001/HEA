...
export class GasListComponent implements OnInit, AfterViewInit {
  ...
  searchData() {
    ...
    if ((this.f.year.value !== undefined && this.f.year.value !== '') || (this.f.month.value !== undefined && this.f.month.value !== '')) {
      this.usageHistoryList = new Array;
      for (const gesList of this.users.gasList) {
        this.filtercheck = true;
        if ((this.f.year.value !== undefined && this.f.year.value !== '') && (this.f.month.value !== undefined && this.f.month.value !== '')) {
          this.filtercheck = false;
          if (gesList.year === this.f.year.value && gesList.month === this.f.month.value) {
            this.filtercheck = true;
          }
        } else if (this.f.year.value !== undefined && this.f.year.value !== '') {
          this.filtercheck = false;
          if (gesList.year === this.f.year.value) {
            this.filtercheck = true;
          }
        } else if (this.f.month.value !== undefined && this.f.month.value !== '') {
          this.filtercheck = false;
          if (gesList.month === this.f.month.value) {
            this.filtercheck = true;
          }
        } if (this.filtercheck) {
